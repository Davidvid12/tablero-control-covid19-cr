---
title: "Estado del COVID-19 en Costa Rica (Por Leandro Rodríguez B. David Aguilar A. Luis Vega González)"
output: 
...
icono_mujeres <- 'fa-female'

icono_hombres <- 'fa-male'

icono_fallecidos <- 'fa-times'

icono_menores <- 'fa-child'

icono_mayores <- 'fa-blind'

iconos_adultos <- 'fa-user'
...
plot_ly(data = df_general_pais,
  ...
  layout(title = "",
                 ...
                 hovermode = "compare") %>% config(locale = 'es' )
...
### Casos activos {.value-box}
```{r}
valueBox(value = paste(format(df_general_pais_ultima_fecha$activos, big.mark = ","), "(+", ( df_general_pais_ultima_fecha$nue_posi), ")" , sep = " "),  
         caption = "Total de casos activos", 
         icon = icono_activos, 
         color = color_activos
)
...
valueBox(value = paste( "(",
                       ...
                       "%)" ),
         caption = "Adult@s Mayores Recuperados", 
         icon = icono_mayores, 
         color = color_recuperados
)
```
...
valueBox(value = paste( "(",
                       ...
                       "%)" ), 
         caption = "Adult@s Mayores Fallecid@s", 
         icon = icono_mayores, 
         color = color_fallecidos
)
```
